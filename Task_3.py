    ...
    def planning(self, sx, sy, gx, gy):
        ...
        while 1:
            ...
            if current.x == goal_node.x and current.y == goal_node.y:
                ...
                F = 20 # Kg per minute
                usdbbl = 106.95 # usd/bbl for Asia n Oceania Region


                for add_pass in range(0, 350):
                    passengers = 100 + add_pass # number of passengers  [100, 450]
                    Cfuel = usdbbl / 119.24047 # 1 barrel [US, liquid] to kilo gram = 119.24047 kilo gram, $ per kg
                    m = math.ceil(passengers/50) # by what value it is increased
                ...
                if bestpassengers >= 300:
                    print("Total cost of 4-engine B747-> ",lowest)
                    print("Passenger capacity of B747-> ",bestpassengers)
                else:
                    print("Total cost of twin-engine PLANE-> ",lowest)
                    print("Passenger capacity of PLANE->",bestpassengers)
                break
...
def main():
    ...
    for i in range(-5, 10): # draw the obstacle
        ox.append(20.0)
        oy.append(i)
    ...
    if show_animation:  # pragma: no cover
        ...
        plt.plot(gx, gy, "xg") # plot the end position
