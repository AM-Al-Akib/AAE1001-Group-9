...
My assignment is to add to the code from Task 1. It's both easy and challenging. The easy part is that I don't have to write a new code from the beginning, as I can edit and improve parts of the existing code. The hard part is understanding the original code to know where to make changes. Going through the whole code and figuring out how it works is really satisfying, especially when I can add my own work to it successfully.
